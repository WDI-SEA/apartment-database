...
SELECT * FROM owner, properties WHERE owner.id = properties.owner_id ORDER BY owner.name;


-- 12. Show all of the properties in alphabetical order that are not named Archstone and do not have an id of 3 or 5.
SELECT * FROM properties WHERE name != 'Archstone' and id NOT IN (3,5) ORDER BY name;
