...
UPDATE properties SET owner_id='7' WHERE owner_id='3';
...
SELECT * FROM properties WHERE name NOT IN ('Archstone') AND id NOT IN (3, 5) ORDER BY name;
...
SELECT COUNT(*) FROM properties WHERE owner_id > 1 AND owner_id < 4;
-- BONUSES
...
-- Well, we deleted Janet so I'll add Mr. Lahey to the trailer park!!!
INSERT INTO owners (name, age) VALUES ('Jim Lahey', 71,3);
INSERT INTO properties (name, units, owner_id)
VALUES ('West Winds', 40, 3);
