...
insert into owner (name, age) values ('Soma', 16);
insert into owner (name, age) values ('Erina', 16);
insert into owner (name, age) values ('Satoshi', 17);
...
insert into properties (name, units, owner_id) values ('Willow Creek', 18, 9);
insert into properties (name, units, owner_id) values ('Blue Mountain', 27, 7);
insert into properties (name, units, owner_id) values ('Hill Country', 22, 8);
